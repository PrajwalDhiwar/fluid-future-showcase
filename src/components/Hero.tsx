    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-brand-dark to-brand-purple">
      ...
      <div className="absolute inset-0">
        <svg className="w-full h-full opacity-10" viewBox="0 0 100 100" preserveAspectRatio="none">
          ...
          />
          {/* AI Agent Nodes */}
          <circle cx="20" cy="50" r="2" className="fill-brand-purple animate-pulse" />
          <circle cx="50" cy="50" r="2" className="fill-brand-purple animate-pulse [animation-delay:500ms]" />
          <circle cx="80" cy="50" r="2" className="fill-brand-purple animate-pulse [animation-delay:1000ms]" />
        </svg>
      </div>
      
      {/* Glowing Orbs representing AI agents */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute w-32 h-32 bg-brand-purple/20 rounded-full blur-3xl animate-[float_6s_ease-in-out_infinite] top-1/4 left-1/4"></div>
        <div className="absolute w-32 h-32 bg-blue-500/20 rounded-full blur-3xl animate-[float_8s_ease-in-out_infinite] top-1/2 right-1/4 [animation-delay:1s]"></div>
        <div className="absolute w-32 h-32 bg-purple-500/20 rounded-full blur-3xl animate-[float_7s_ease-in-out_infinite] bottom-1/4 left-1/3 [animation-delay:2s]"></div>
      </div>
